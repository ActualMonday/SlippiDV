...
async function processSlpFile(filePath) {
    try {
        ...
        if (settings.players.length > 2) return null; //checks if games are just between 2 people

        // Identify player and opponent index////////////////////////////////////////////////////////////////////
        ...
        stats.conversions
            .filter(c => c.didKill && c.playerIndex === oppIndex)
            .forEach(c => {
